<?php
$strTitle = "CIOC Software Site Directory";
$strSection = "Directory";
...
?>
    ...
    <div class="jumbotron">
      <div class="container">
      	<h1><?=$strTitle?></h1>
			<p>CIOC Software is used to connect hundreds of thousands of people to community and government services, businesses, and volunteer opportunities each year. If you use CIOC Software and would like to list your public database built on CIOC Software or using the CIOC API, please <a href="http://www.kclsoftware.com/contact-us/">contact us</a>. Please note: Listings do not constitute endorsement. We reserve the right to decline a request for listing for any reason.</p>
      </div>
    </div>
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div class="list-group">
						<a class="list-group-item" href="https://clbc.cioc.ca" target="_blank">Community Living British Columbia</a>
					...
					<div class="list-group">
						...
						<a class="list-group-item" href="https://seniors.durham.cioc.ca" target="_blank">Durham Region Services for Seniors</a>
						<a class="list-group-item" href="https://youth.durham.cioc.ca" target="_blank">Durham Region Youth Services</a> 
						<a class="list-group-item" href="https://dufferin-peel.cioc.ca" target="_blank">Dufferin-Peel Community Information Database</a>
						<a class="list-group-item" href="https://easternontario.cioc.ca" target="_blank">Eastern Ontario Community Information Database (Ottawa, Frontenac, Lanark, Hastings, Lanark, Leeds and Grenville, Lennox and Addington, Prescott and Russell, Prince Edward, Renfrew County, Stormont, Dundas and Glengarry)</a>
						<a class="list-group-item" href="https://foodinsimcoe.cioc.ca" target="_blank">Food in Simcoe County</a>
						<a class="list-group-item" href="https://fourinfo.cioc.ca" target="_blank">FourInfo (Haliburton, Kawartha Lakes, Northumberland, Peterborough)</a>
						...
						<a class="list-group-item" href="https://simcoecounty.cioc.ca" target="_blank">Info Simcoe County</a>
						<a class="list-group-item" href="https://durham.cioc.ca" target="_blank">Information Durham</a>
						<a class="list-group-item" href="https://orillia.cioc.ca" target="_blank">Information Orillia</a>
						<a class="list-group-item" href="https://orilliabusiness.cioc.ca" target="_blank">Information Orillia - Business Directory</a>
						<a class="list-group-item" href="https://niagara.cioc.ca" target="_blank">INCommunities (Niagara)</a>
						<a class="list-group-item" href="https://midlandseniors.cioc.ca" target="_blank">Midland Senior's Services Directory</a>
						<a class="list-group-item" href="https://muskokaemergency.cioc.ca" target="_blank">Muskoka Emergency Measures</a>
						<a class="list-group-item" href="https://niagaraimmigration.cioc.ca" target="_blank">Niagara Newcomers Portal</a>
						<a class="list-group-item" href="https://niec.cioc.ca/" target="_blank">Niagara Immigrant Employment Council - Programs &amp; Services for Immigrants</a>
						<a class="list-group-item" href="https://northbook-durham.cioc.ca" target="_blank">Northbook Durham - Basic Needs Support</a>
					...
					<h3>New Brunswick</h3>
					<div class="list-group">
						<a class="list-group-item" href="http://211nb.ca" target="_blank">211 New Brunswick</a>
						<a class="list-group-item" href="http://www.frederictoninfo.ca" target="_blank">Info Fredericton</a>
						<a class="list-group-item" href="https://infocharlotte.cioc.ca" target="_blank">Info Charlotte County</a>
						<a class="list-group-item" href="https://saintjohn.cioc.ca" target="_blank">Info Saint John</a>
					</div>
					...
					<div class="list-group">
						...
						<a class="list-group-item" href="https://southshoreconnect.cioc.ca/" target="_blank">South Short Connect</a>
					</div>
					
					<h3>Prince Edward Island</h3>
					<div class="list-group">
						<a class="list-group-item" href="https://pei.cioc.ca" target="_blank">211 Prince Edward Island</a>
					</div>
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<h3>British Columbia</h3>
					<div class="list-group">
						<a class="list-group-item" href="https://kelowna.cioc.ca/volunteer/" target="_blank">Kelowna Community Resources - Volunteer Directory</a>
					</div>
					...
					<div class="list-group">
						...
						<a class="list-group-item" href="https://niagara.cioc.ca/volunteer/" target="_blank">INCommunities - Volunteer Directory (Niagara)</a>
						<a class="list-group-item" href="https://niagaradonates.cioc.ca/volunteer/" target="_blank">Niagara Donation of Goods Portal</a>
						<a class="list-group-item" href="https://brucegrey.cioc.ca/volunteer/" target="_blank">Volunteer Connection Bruce &amp; Grey Counties</a>
						<a class="list-group-item" href="https://muskokadistrict.cioc.ca/volunteer/" target="_blank">Volunteer Connection Muskoka District</a>
						<a class="list-group-item" href="https://parrysounddistrict.cioc.ca/volunteer/" target="_blank">Volunteer Connection Parry Sound District</a>
						...
						<a class="list-group-item" href="https://halton.cioc.ca/volunteer/" target="_blank">Volunteer Halton</a>
						<a class="list-group-item" href="https://southsimcoecic.cioc.ca/volunteer/" target="_blank">Volunteer South Simcoe</a>
						<a class="list-group-item" href="http://www.yorkinfo.ca/volunteer/" target="_blank">York Info - Volunteer Directory</a>
					</div>	
				</div>
			</div>
		</div>
