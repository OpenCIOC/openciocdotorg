...
<div class="jumbotron">
	<div class="container">
		<h1><?=$strTitle?></h1>
		<p>
  			<?php include("snippets/wp-desc.html")?>. Don't use WordPress? Re-use the Open Source PHP Code from these plug-ins to do integration in any PHP-based website or CMS.	
  			</p>
	</div>
</div>
