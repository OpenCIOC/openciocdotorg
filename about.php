...
?>
	...
	<p>Those looking for a turn-key solution for using these applications can contact <a href="http://www.kclsoftware.com/contact-us/">KCL Software Solutions Inc.</a> or <a href="https://www.cioc.ca/contact.aspx">CIOC</a> for information about hosted services or application configuration support.</p>

	<h2>Becoming a Contributor</h2>
	<p>Are you interested in participating in the OpenCIOC project? We're not quite ready to accept contributions to most projects yet, but if you are interested in contributing please <a href="">be in touch</a>!</p>
	
	<h2>Getting Project Updates</h2>
	<p>The OpenCIOC project began in early 2015, and it is expected that all projects will be avaialble by the end of 2015. Information on the status of each individual product will be posted on the project information page for that product, and further updates are avialable through <a href="http://new.kclsoftware.com/category/cioc-software/">KCL's blog</a></p> 
