...
$strPluginType = "CIOC Remote Search and Details Plug-in";
...
?>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<p>Below is documentation for configuring WordPress shortcodes for the <?=$strPluginType?>.</p>
	...
	<div class="container">
		...
		<div class="well">
			<h2>Contents</h2>
			<ul>
				<li><a href="#install">Installing the Plug-in</a></li>
				<li><a href="#api-info">CIOC API Reference and Configuration</a></li>
				<li><a href="#get-key">Obtaining an API ID and Password</a></li>
				<li><a href="#api-settings">CIOC API Settings</a></li>
				<li>
					<a href="#shortcode">Shortcode Reference</a>
					<ul>
						<li><a href="#shortcode-view-lang">Changing the View or Language</a></li>
						<li><a href="#shortcode-countall">Count All Records</a></li>
						<li><a href="#shortcode-quicklist-browse">Browse Categories</a></li>
						<li><a href="#shortcode-searchform">Generate a Search Form</a></li>
						<li><a href="#shortcode-searchform-elements">Generate Individual Search Form Elements</a></li>
						<li><a href="#shortcode-displayresults">Search Results</a></li>
						<li><a href="#shortcode-displayrecord">Record Details</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<a name="api-info"></a>
		<h2>CIOC API Reference and Configuration</h2>
		<p>This plug-in works against the CIOC Remote Search and Details API. Many settings, including the fields and data avaialble, are determined by the API setup and not the WordPress plugin. Please access <a href="http://ciocapidocs.readthedocs.io">the documentation for the CIOC Remote Search and Details API</a> for information on customizing data sets, fields, record details pages, and so on.</p>
		<div class="alert alert-danger">When configuring an API Account, please take proper security measures to ensure that the API Account is configured to have access only to appropriate Views, Records, and Fields.</div>

		<a name="get-key"></a>
		<h2>Obtaining an API ID and Password</h2>
		<p>To use the plug-in, you must have an active API ID from the target database connected to an account with permissions to access the "CIOC Remote Search and Details API" (this setting is part of the <em>User Type</em> in CIOC). The CIOC User account with permissions for the API can sign into CIOC to generate an API ID/Password pair for each site. Click on your user name in the top site-bar menu to access the My Account page.</p>
		<div class="callout">My Account &gt; Manage API IDs</div>
		<p>Best Practices for configuring API IDs:</p>
		<ul>
			<li>When configured, API IDs should be named in a way that clearly indicates their purpose.</li>
			<li>API Passwords are only available at the time they are generated and cannot be recovered. If you lose your password, you must generate a new ID/Password combination.</li>
			<li>In general, IDs should be for one purpose and not shared; in that way, an ID can be deactivated due to problem use without impacting others. There is no limit on the number of IDs that can be generated.</li>
			<li>When no longer in use, API IDs should be deleted.</li>
		</ul>
		...
		<ul>
			...
			<li><code>limitcmtype="L|S"</code> - optional, to pre-set the drop-down to limit by either <em>Located in Community</em> (<mark>L</mark>) or <em>Serving Community</em> (<mark>S</mark>)</li>
